...
const page = () => {
    ...
    const fetchStudents = async () => {
        try {
            const response = await fetch("/api/students?level=S.6");
    ...
    const fetchGrading = async () => {
        try {
            const response = await fetch("/api/scale?name=A-Level");
            if (!response.ok) {
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-bold mb-4">Manage Senior Six Results</h2>
            ...
            <MarksEntry gradeSystem={grading} level={"S.6"} onSubmit={submitResults} open={openMarksEntry} setOpen={setOpenMarksEntry} student={editRow} />
